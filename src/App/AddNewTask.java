...
public class AddNewTask extends javax.swing.JFrame {
    ...
    private void initDesign(){
        ...
        //the to fields by default will be disabled
        toDateField.setEnabled(false);
        toYearField.setEnabled(false);
        monthToComboBox.setEnabled(false);
        pack();
    ...
    private void getNewID(){
        ...
        try{
            ...
            //if it is the first task, then set the new task id as t1
            if(allIdList.isEmpty()){
                this.lastID = "t1";
            }
            else{ //generate the ID based on the last ID in the task table
                ...
                idnow++; //add 1 from the last task ID
